-- Fix create_tickets_from_order function to resolve type casting issues
...
BEGIN
  ...
  LOOP
    -- Explicitly cast all values to text to avoid type conflicts
...
DO $$
BEGIN
  RAISE NOTICE 'create_tickets_from_order function updated successfully';
END;
$$;